    ...
    return (
      <Row>
        ...
        >
          ...
          {props.selected && <Done fontSize="1rem" />}
        </Colorbox>
        <IconWrapper
          onClick={() => {
            setSelectedCard({
        ...
        >
          <EditOutlined color="#091e42" fontSize="1rem" />
        </IconWrapper>
      </Row>
    );
  };
        ...
        <SmallColorsContainer>
          {colors.map((color) => {
            return (
              ...
              >
                {color.bg === createColor && <Done fontSize="1rem" />}
              </SmallColorBox>
            );
          })}
        </SmallColorsContainer>
        ...
        <SmallColorsContainer>
          {colors.map((color) => {
            return (
              ...
              >
                {changeColor === color.bg && <Done fontSize="1rem" />}
              </SmallColorBox>
            );
          })}
        </SmallColorsContainer>
